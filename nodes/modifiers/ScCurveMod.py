...
class ScCurveMod(Node, ScModifierNode):
    ...
    def init(self, context):
        ...
        self.inputs.new("ScNodeSocketString", "Deformation Axis").init(
            "in_deform_axis", True
        )
    ...
    def error_condition(self):
        return (
            ...
            or (
                not self.inputs["Deformation Axis"].default_value
                in ["POS_X", "POS_Y", "POS_Z", "NEG_X", "NEG_Y", "NEG_Z"]
            )
        )

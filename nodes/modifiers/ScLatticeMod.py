...
class ScLatticeMod(Node, ScModifierNode):
    ...
    in_strength: FloatProperty(
        default=1.0, soft_min=0.0, soft_max=1.0, update=ScNode.update_value
    )
    in_lattice: PointerProperty(
        type=bpy.types.Object, poll=sc_poll_lattice, update=ScNode.update_value
    )
    ...
    def error_condition(self):
        return super().error_condition() or self.inputs["Lattice"].default_value == None

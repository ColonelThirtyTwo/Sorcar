...
class ScWeldMod(Node, ScModifierNode):
    ...
    in_distance: FloatProperty(
        default=0.001, min=0.0, soft_max=1.0, update=ScNode.update_value
    )
    ...
    def functionality(self):
        ...
        bpy.context.object.modifiers[self.prop_mod_name].max_interactions = int(
            self.inputs["Duplicate Limit"].default_value
        )

...
class ScWireframeMod(Node, ScModifierNode):
    ...
    def init(self, context):
        ...
        self.inputs.new("ScNodeSocketBool", "Relative Thickness").init(
            "in_use_relative_offset"
        )
        self.inputs.new("ScNodeSocketBool", "Boundary").init("in_use_boundary")
        self.inputs.new("ScNodeSocketBool", "Replace Original").init(
            "in_use_replace", True
        )
    ...
    def functionality(self):
        ...
        bpy.context.object.modifiers[self.prop_mod_name].use_crease = self.inputs[
            "Crease Edges"
        ].default_value
        bpy.context.object.modifiers[self.prop_mod_name].crease_weight = self.inputs[
            "Crease Weight"
        ].default_value
        ...
        bpy.context.object.modifiers[self.prop_mod_name].use_boundary = self.inputs[
            "Boundary"
        ].default_value
        bpy.context.object.modifiers[self.prop_mod_name].use_replace = self.inputs[
            "Replace Original"
        ].default_value

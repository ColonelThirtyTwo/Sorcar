...
class ScLocalTransform(Node, ScTransformNode):
    ...
    def error_condition(self):
        return (
            ...
            or (
                self.inputs["Mode"].default_value
                in ["CREASE", "SKIN_RESIZE", "EDGESLIDE"]
                and not self.inputs["Edit Mode"].default_value
            )
        )
    ...
    def functionality(self):
        bpy.ops.transform.transform(
            ...
            value=(
                self.inputs["X"].default_value,
                self.inputs["Y"].default_value,
                self.inputs["Z"].default_value,
                self.inputs["W"].default_value,
            ),

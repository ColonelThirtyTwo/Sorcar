...
class ScShading(Node, ScObjectOperatorNode):
    ...
    in_shading: EnumProperty(
        items=[("SMOOTH", "Smooth", ""), ("FLAT", "Flat", "")],
        default="FLAT",
    ...
    def error_condition(self):
        return (
            ...
            or (
                self.inputs["Angle"].default_value < 0.0
    ...
    def functionality(self):
        ...
        self.inputs["Object"].default_value.data.use_auto_smooth = self.inputs[
            "Auto Smooth"
        ].default_value
        self.inputs["Object"].default_value.data.auto_smooth_angle = self.inputs[
            "Angle"
        ].default_value

...
class ScClearParent(Node, ScObjectOperatorNode):
    ...
    ops_type: EnumProperty(
        items=[
            ("CLEAR", "Normal", ""),
            ("CLEAR_KEEP_TRANSFORM", "Keep Transform", ""),
    ...
    def error_condition(self):
        return super().error_condition() or (
            ...
            in ["CLEAR", "CLEAR_KEEP_TRANSFORM", "CLEAR_INVERSE"]
        )

    def functionality(self):
        bpy.ops.object.parent_clear(type=self.inputs["Type"].default_value)

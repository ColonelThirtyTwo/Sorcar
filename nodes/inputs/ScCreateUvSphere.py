...
class ScCreateUvSphere(Node, ScInputNode):
    ...
    def error_condition(self):
        return (
            ...
            or (
                self.inputs["Segments"].default_value < 3
                or self.inputs["Segments"].default_value > 10000000
            )
            or (
                self.inputs["Rings"].default_value < 3
                or self.inputs["Rings"].default_value > 10000000
            )

...
class ScComponentInfo(Node, ScNode):
    ...
    in_component: EnumProperty(
        name="Component",
        items=[("FACE", "Face", ""), ("VERT", "Vertex", ""), ("EDGE", "Edge", "")],
        default="FACE",
    ...
    def post_execute(self):
        ...
        if self.inputs["Component"].default_value == "FACE":
            ...
            area = [
                0 for i in self.inputs["Object"].default_value.data.vertices if i.select
            ]
            ...
            area = [
                0 for i in self.inputs["Object"].default_value.data.edges if i.select
            ]
        l = Vector((0, 0, 0))
        r = Vector((0, 0, 0))
        a = 0

...
class ScSelectAxis(Node, ScSelectionNode):
    ...
    in_threshold: FloatProperty(
        default=0.0001, min=0.000001, max=50, update=ScNode.update_value
    )
    ...
    def error_condition(self):
        return (
            ...
            or (
                self.inputs["Threshold"].default_value < 0.000001
                or self.inputs["Threshold"].default_value > 50
            )
        )

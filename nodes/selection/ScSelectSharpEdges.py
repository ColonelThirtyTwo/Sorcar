...
class ScSelectSharpEdges(Node, ScSelectionNode):
    ...
    in_sharpness: FloatProperty(
        default=0.523599, min=0.000174533, max=3.14159, update=ScNode.update_value
    )
    ...
    def error_condition(self):
        return super().error_condition() or (
            self.inputs["Sharpness"].default_value < 0.000174533
            or self.inputs["Sharpness"].default_value > 3.14159
        )

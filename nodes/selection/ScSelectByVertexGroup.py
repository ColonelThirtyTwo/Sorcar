...
class ScSelectByVertexGroup(Node, ScSelectionNode):
    ...
    def draw_buttons(self, context, layout):
        ...
        if not self.inputs["Object"].default_value == None:
            layout.prop_search(
                self, "prop_vg", self.inputs["Object"].default_value, "vertex_groups"
            )
    ...
    def error_condition(self):
        return (
            ...
            or self.prop_vg == ""
            or self.inputs["Object"].default_value.vertex_groups.get(self.prop_vg)
            == None
        )
    ...
    def functionality(self):
        self.inputs["Object"].default_value.vertex_groups.active_index = (
            self.inputs["Object"].default_value.vertex_groups[self.prop_vg].index
        )
        if self.inputs["Deselect"].default_value:

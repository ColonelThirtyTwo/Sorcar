...
class ScDecimate(Node, ScEditOperatorNode):
    ...
    def init(self, context):
        ...
        self.inputs.new("ScNodeSocketString", "Symmetry Axis").init(
            "in_symmetry_axis", True
        )
    ...
    def error_condition(self):
        return (
            ...
            or (
                ...
                or self.inputs["Ratio"].default_value > 1.0
            )
            or (
                self.inputs["Weight"].default_value < 0.0
                or self.inputs["Weight"].default_value > 1000.0
            )

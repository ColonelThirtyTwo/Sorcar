...
class ScLoopCut(Node, ScEditOperatorNode):
    ...
    in_smoothness: FloatProperty(
        soft_min=-4.0, soft_max=4.0, update=ScNode.update_value
    )
    ...
    def init(self, context):
        ...
        self.inputs.new("ScNodeSocketBool", "Use selected edge").init(
            "in_use_selected_edge", True
        )
    ...
    def functionality(self):
        ...
        bpy.ops.mesh.loopcut_slide(
            ...
            TRANSFORM_OT_edge_slide={"value": self.inputs["Factor"].default_value},
        )

...
def update_notice_box_ui(self, context):
    ...
    if updater.manual_only == False:
        colR.operator(
            addon_updater_update_now.bl_idname, text="Update", icon="LOOP_FORWARDS"
        )
...
def register(bl_info):
    ...
    updater.website = "https://github.com/aachman98/Sorcar/"
